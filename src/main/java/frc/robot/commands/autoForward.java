...
public class autoForward extends Command {
    ...
    Pose2d finalPose;
    double toleranceMemers = 0.5;

    public autoForward(SwerveDrivebase drivebase) {
    ...
    public void initialize() {
        finalPose = swerveDrivebase.getPose2d().transformBy(new Transform2d(new Translation2d(1.2,0), new Rotation2d(swerveDrivebase.getPose2d().getRotation().getDegrees())));
    }
