...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        pointsOfInterest.add(2, new PointOfInterest("Blue Stage down", new Translation2d(4.05, 2.75), Rotation2d.fromDegrees(-120), 1, 0.1));
        ...
        pointsOfInterest.add(5, new PointOfInterest("Red Stage up", new Translation2d(12.47, 5.21), Rotation2d.fromDegrees(60), 1, 0.1));
        pointsOfInterest.add(6, new PointOfInterest("Red Stage down", new Translation2d(12.45, 2.95), Rotation2d.fromDegrees(-60), 1, 0.1));
